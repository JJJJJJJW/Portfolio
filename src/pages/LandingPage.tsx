...
const techLogos = [
    ...
    { node: <span className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 rounded-full text-sm font-semibold border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 whitespace-nowrap shadow-lg"><SiTailwindcss className="text-[#06B6D4] text-lg" /> Tailwind v4</span> },
